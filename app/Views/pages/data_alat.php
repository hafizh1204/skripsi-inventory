    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        <div class="w-full flex flow-row justify-between items-center mt-6">
            ...
            <div class="w-full h-fit flex flex-row justify-end gap-x-5">
                ...
                <a href="/alat/insertAlat" class="bg-lime-600 text-white py-2 px-5 flex flex-row items-center gap-x-3 rounded-lg shadow-md hover:bg-lime-800 hover:shadow-none">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-3">
                            <div class="flex flex-row items-center justify-center gap-x-2">
                                ...
                                <button data-modal-target="popup-delete-modal" data-modal-toggle="popup-delete-modal" class="bg-red-600 hover:bg-red-800 text-white text-sm font-semibold px-4 py-2 rounded-md" type="button">Hapus</button>
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda yakin ingin menghapus data ini ?</h3>
                                                    ...
                                                    <a href="/hapus/hapusAlat/<?= $alatdjm['id']?>" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                                    Yakin
                                                    </a>
